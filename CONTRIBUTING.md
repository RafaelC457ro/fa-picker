...
## Reporting Issues
Found a problem? Want a new feature? First of all see if your issue or idea has [already been reported](https://github.com/RafaelC457ro/fa-picker/issues).
If don't, just open a [new clear and descriptive issue](https://github.com/RafaelC457ro/fa-picker/issues/new).
